...
class User(AbstractUser):
    username = None  # убирает username из полей
    ...
    USERNAME_FIELD = 'email'  # указывает какое поле использовать при логине
...
class Billing(models.Model):
    ...
    def withdraw(self, amount):
        """Снятие счета со счета, если транзакция прошла успешно, вернется True"""
